...
namespace larlitecv {
  ...
  void FlashEndContourFinderConfig::setdefaults() {
  ...
  FlashEndContourFinderConfig FlashEndContourFinderConfig::FromPSet( const larcv::PSet& flashtagger_pset ) {
    FlashEndContourFinderConfig flashtagger_cfg;
